...
def _pivot_col(T, tol=1.0E-10, bland=False):
    """
...
def _pivot_row(T, basis, pivcol, phase, tol=1.0E-10, bland=False):
    """
...
def _solve_simplex(T, n, basis, maxiter=1000, phase=2, callback=None,
                   tol=1.0E-10, nit0=0, bland=False):
    """
...
def _linprog_simplex(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,
                     ...
                     tol=1.0E-10, bland=False, **unknown_options):
    """
